...
async def download_csv(type: str):
    ...
    try:
        ...
        output = io.StringIO()
        if res.data:
            headers = ["company", "industry", "confidence_score", "funding_amount", "funding_round", "strategic_signal", "integration_opportunity", "patron_chairman", "ceo_founder", "financials", "registry_status", "status", "url", "contact_name", "contact_role", "contact_email", "contact_linkedin", "discovered_at"]
